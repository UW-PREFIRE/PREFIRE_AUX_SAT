...
of the provenance of this package's products ('AUX-SAT'); write to file.
...
Pypackages_to_query = ("PREFIRE_AUX_SAT", "PREFIRE_AUX_MET", "PREFIRE_PRD_GEN",
                       "PREFIRE_tools")
...
if __name__ == "__main__":
    ...
    arg_description = ("Determine product monikers and current (latest) git "
                       ...
                       "package's products ('AUX-SAT'); write to file.")
